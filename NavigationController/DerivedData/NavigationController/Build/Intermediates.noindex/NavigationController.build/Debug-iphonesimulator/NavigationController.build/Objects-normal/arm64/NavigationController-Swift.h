...
#ifndef NAVIGATIONCONTROLLER_SWIFT_H
#define NAVIGATIONCONTROLLER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NavigationController",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20NavigationController19FirstViewController")
...
SWIFT_CLASS("_TtC20NavigationController13SceneDelegate")
