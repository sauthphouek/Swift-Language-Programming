...
extension ImageResource {
    ...
    static let sticker = ImageResource(name: "sticker", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "sticker" asset catalog image.
    static var sticker: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .sticker)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "sticker" asset catalog image.
    static var sticker: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .sticker)
#else
        .init()
